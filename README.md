...
<h4 align="center">Todo lo necesario para crear el agente en N8N se encuentra en la carpeta assets. GPT 5.0 baja los costo al seleccionarlo como agente, para produccion seleccionar una base de datos PostgreSQL en vez de Simple Memory </h4>
